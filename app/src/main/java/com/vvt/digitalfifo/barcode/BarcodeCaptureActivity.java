 ...
 */
package com.vvt.digitalfifo.barcode;
...
import com.vvt.digitalfifo.camera.CameraSource;
import com.vvt.digitalfifo.camera.CameraSourcePreview;
...
public final class BarcodeCaptureActivity extends AppCompatActivity
    ...
    // Utilities used to pass extra data in the intent
        ...
        switch (requestCode)
        {
            case MULTIPLE_PERMISSIONS: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Log.d(TAG,"permission string"+perStr);
