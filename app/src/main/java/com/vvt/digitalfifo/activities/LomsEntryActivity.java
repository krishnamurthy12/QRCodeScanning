...
public class LomsEntryActivity extends AppCompatActivity implements View.OnClickListener,OnResponseListener {

    CardView mLomsIn,mLomsOut;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loms_entry);
    ...
    private void initializeViews() {
        ...
        TextView mTitle = findViewById(R.id.vT_ale_title);
        mTitle.setTypeface(historiaTypeface);

        TextView mVersion=findViewById(R.id.vT_ale_versionname);
        ...
        mProgressBar=findViewById(R.id.vP_ale_progressbar);
        mProgressBar.setVisibility(View.GONE);

        mLomsIn=findViewById(R.id.vC_ale_kanbanin);
        mLomsOut=findViewById(R.id.vC_ale_kanbanout);

        mLogOut=findViewById(R.id.vL_ale_logout);

        mLomsIn.setOnClickListener(this);
        mLomsOut.setOnClickListener(this);
